...
class SolidEnvironmentCV(SolidEnvironment):
    ...
    def __init__(self, id_number, weight, grayscale, cluster, classifier=True, preference=True, decision_period=10, target_arousal=1, period_ra=False, imitate=False):
        ...
        super().__init__(id_number=id_number, graphics=True,
                         ...
                         decision_period=decision_period, target_arousal=target_arousal, period_ra=period_ra, imitate=imitate)
        self.frame_buffer = []
