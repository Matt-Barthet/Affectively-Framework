...
class HeistEnvironment(BaseEnvironment):
    ...
    def __init__(self, id_number, graphics, weight, obs, targetArousal, frame_buffer, cluster, period_ra, args=None, classifier=True, preference=True, decision_period=10, capture_fps=10, sensitivity=1,correct_step_bug=True):
        ...
        super().__init__(id_number=id_number, game='fps', graphics=graphics, obs_space=obs, args=args,
                         ...
                         decision_period=decision_period, correct_step_bug=correct_step_bug)
