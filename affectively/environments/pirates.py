...
class PiratesEnvironment(BaseEnvironment):
    ...
    def __init__(self, id_number, graphics, weight, obs, frame_buffer, cluster, period_ra, target_arousal, absolute=False, args=None, classifier=True, preference=True, capture_fps=60, decision_period=10, imitate=False, correct_step_bug=True):
        ...
        super().__init__(id_number=id_number, game='platform', graphics=graphics, obs_space=obs, args=args,
                         ...
                         period_ra=period_ra, target_arousal=target_arousal, classifier=classifier, preference=preference, decision_period=decision_period, imitate=imitate, correct_step_bug=correct_step_bug)
