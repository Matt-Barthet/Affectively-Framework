...
class SolidEnvironment(BaseEnvironment):
    ...
    def __init__(self, id_number, graphics, weight, obs, frame_buffer, cluster, target_arousal, period_ra, args=None, classifier=True, preference=True, decision_period=10, capture_fps=5, imitate=False, correct_step_bug=True):
        ...
        super().__init__(id_number=id_number, game='Solid', graphics=graphics, obs_space=obs, args=args,
                         ...
                         target_arousal=target_arousal, period_ra=period_ra, classifier=classifier, preference=preference, decision_period=decision_period, imitate=imitate, correct_step_bug=correct_step_bug)
