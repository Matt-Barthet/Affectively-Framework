...
class HeistEnvironmentGameObs(HeistEnvironment):
    ...
    def __init__(self, id_number, graphics, weight, logging=True, log_prefix="", discretize=False, cluster=0, target_arousal=0, period_ra=False):
        self.gridWidth = 9
        self.gridHeight = 9
        ...
        super().__init__(id_number=id_number, graphics=graphics, 
                         ...
                         weight=weight, logging=logging, log_prefix=log_prefix, frame_buffer=False, cluster=cluster, targetArousal=target_arousal, period_ra=period_ra)
