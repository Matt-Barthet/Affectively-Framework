...
class KNNSurrogateModel:
    ...
    def load_data(self):
        fname = f'../../../affectively_environments/datasets/{self.game}_nonorm_with_clusters.csv'
        fname_train = f'../../../affectively_environments/datasets/{self.game}_pairs_classification.csv'
