...
def optimise(pos_pool, visited_states, actions_data, env, original_state, original_save_num, original_dist_x, original_dist_y, original_damage, original_death, original_score, original_kill_count):
    plan_ahead = 2
    steps_per_search = 1
    ...
    return search_count, best_pos, latest_save_num, pos_pool, visited_states
...
class AstarAgent:    
    ...
    def AStarRun(self, segments) :
        ...
        while True:   
            ...
            main_search_count, main_best_pos, main_new_save_load_num, main_pos_pool, main_visited_states = optimise(main_pos_pool, main_visited_states, main_actions_data, main_env, main_state, main_new_save_load_num, main_dist_x, main_dist_y, main_damage, main_death, main_score, main_kill_count)

            # print("main_search_count: " + str(main_search_count))

            if main_search_count >= 500 or main_search_count == 0:
                playable = False
                print("Close 1")
                main_env.env.close()
